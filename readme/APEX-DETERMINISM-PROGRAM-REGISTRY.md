...
| 34 | `APEX-T5.5` | RESERVED (GUIDE_MISSING_ROW) -- no APEX-T5.5 packet exists in the canonical guide; content TBD from source, routed to guide author | — | `DET-PRD-008`, `DET-PRD-011`, `DET-WTH-010` | GUIDE_MISSING_ROW/NOT_APPLICABLE/BLOCKED_ON_MISSING_SPEC/NOT_STARTED/NOT_DEPLOYED |
