...
1. **`ORDER_VIOLATION` (was): `APEX-T4.3` depended on `APEX-T6.2`, which came later in the canonical guide's top-to-bottom sequence.** Fixed by **splitting T4.3** into `APEX-T4.3a` (manifest structure + world seed + worldgen/content protocol identities + site identity/origin/kind root; depends only on `T0.5`; kept the original tier position) and `APEX-T4.3b` (geometry root + economy baseline root; depends on `T6.2`; re-sequenced to after Tier 6). `APEX-T4.5` was re-scoped to depend on `T4.3a` only (schema-compatibility checking does not need `T4.3b`'s numerically-verified root values), which is what actually resolves the cascading order constraint rather than just moving it downstream. **Guard-edge (Fable's follow-up ruling):** `APEX-T4.6` (the mandatory-manifest / staged-epoch-commit flip) now depends on **both** `T4.5` and `T4.3b`, and was re-sequenced alongside `T4.3b` — the schema can go mandatory on `T4.3a` alone, but the actual geometry/economy roots may never be declared authoritative before `T4.3b` closes. **Final, 2026-07-26:** Ben confirmed no upstream guide revision is coming to ratify this split; `T4.3a`/`T4.3b` are locally-canonical row IDs going forward.
2. **`UNRESOLVED_ROW_REFERENCE` (was): `APEX-T5.5` was cited by three findings (`DET-WTH-010`, `DET-PRD-008`, `DET-PRD-011`) but did not exist anywhere in the canonical guide.** Fixed first (2026-07-26) by adding `APEX-T5.5` as a frozen `GUIDE_MISSING_ROW` placeholder row (empty dependencies, fixed title, no fabricated content) per the architect's ruling: content recovery was routed to the guide's author via Ben, never reconstructed by a builder. **Terminal ruling, same day:** Ben confirmed the routed ChatGPT-recovery artifacts were hallucinated — nothing is coming. Fable ruled `APEX-T5.5` `CONFIRMED_PHANTOM` (terminal): `finding_ids` and `hard_dependencies` are now frozen empty, and the three citing findings' `AllOf` closure rules had the `APEX-T5.5` reference voided and re-derived from their remaining real replacement rows (see `readme/apex/APEX-FINDING-STATUS-MATRIX-v1.csv`). The old per-row `check_guide_missing_row_fingerprints` drift-watch (a `GUIDE_MISSING_ROW_FINGERPRINT_DRIFT`-raising tracked-red, M3A-floor-style) is retired — a row confirmed to never have existed and never recur has nothing left to drift-watch for. The validator now carries a general `check_confirmed_phantom_invariants` instead: any `CONFIRMED_PHANTOM` row must have empty `hard_dependencies`/`finding_ids` and no live dependents.
...
| 30 | `APEX-T5.1` | Server-authoritative physics cohort lane | `APEX-T3.1`, `APEX-T3.2`, `APEX-T3.3` | `DET-PRD-008`, `DET-WTH-010` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/NOT_STARTED/NOT_STARTED/NOT_DEPLOYED |
| 31 | `APEX-T5.2` | ClientInputFrameV1 | `APEX-T3.3`, `APEX-T3.6` | `DET-NET-008`, `DET-PRD-001`, `DET-PRD-005`, `DET-PRD-008` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 32 | `APEX-T5.3` | InputReceiptV1 / PlayerPredictionProbeV1 | `APEX-T5.2` | `DET-PRD-005` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 33 | `APEX-T5.4` | Tick-identified glider/weather prediction input | `APEX-T3.4`, `APEX-T5.2` | `DET-PRD-005`, `DET-WTH-010` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 34 | `APEX-T5.5` | TERMINAL (CONFIRMED_PHANTOM) -- no APEX-T5.5 packet ever existed in the canonical guide; Ben confirmed 2026-07-26 the routed ChatGPT-recovery artifacts were hallucinated, no content is coming | — | — | CONFIRMED_PHANTOM/NOT_APPLICABLE/NOT_APPLICABLE_TERMINAL/NOT_APPLICABLE_TERMINAL/NOT_DEPLOYED |
| 35 | `APEX-T6.1` | Numeric attack-surface inventory | `APEX-T0.5` | `DET-PHY-008`, `DET-PHY-024`, `DET-WTH-003` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/NOT_STARTED/NOT_STARTED/NOT_DEPLOYED |
| 36 | `APEX-T6.2` | Dual raw/semantic-quantized state-digest probes | `APEX-T0.2`, `APEX-T0.3` | `DET-PHY-024`, `DET-WTH-003` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 37 | `APEX-T6.3` | Canonicalize PHY-008 collision candidate/contribution order | `APEX-T6.1` | `DET-PHY-008` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/NOT_STARTED/NOT_STARTED/NOT_DEPLOYED |
| 38 | `APEX-T6.4` | NumericProfileV1 empirical certified profile | `APEX-T1.5`, `APEX-T6.2` | `DET-WTH-003` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 39 | `APEX-T6.5` | Selective deterministic transcendental kernels | `APEX-T6.1`, `APEX-T6.2`, `APEX-T6.3`, `APEX-T6.4` | `DET-PHY-024` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_EVIDENCE_GATE/NOT_STARTED/NOT_DEPLOYED |
| 40 | `APEX-T6.6` | Authoritative quantization at commit boundaries | `APEX-T6.2` | `DET-PHY-024`, `DET-PRD-011`, `DET-WTH-003` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_EVIDENCE_GATE/NOT_STARTED/NOT_DEPLOYED |
| 41 | `APEX-T7.1` | Local-player prediction-state kernel scope | — | `DET-PRD-008`, `DET-PRD-011` | NEEDS_DESIGN/NOT_APPLICABLE/BLOCKED_ON_DESIGN/NOT_STARTED/NOT_DEPLOYED |
| 42 | `APEX-T7.2` | Shared fixed-tick locomotion/orientation/glider kernel | `APEX-T5.1`, `APEX-T5.2`, `APEX-T5.3`, `APEX-T5.4`, `APEX-T6.4` | `DET-PRD-014` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 43 | `APEX-T7.3` | Prediction-history ring | `APEX-T7.2` | `DET-PRD-014` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 44 | `APEX-T7.4` | Authoritative-correction reconciliation/replay | `APEX-T7.3` | — | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 45 | `APEX-T7.5` | Bounded fallback to full authoritative snap | `APEX-T7.4` | — | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/NOT_STARTED/NOT_STARTED/NOT_DEPLOYED |
| 46 | `APEX-T4.3b` | WorldBaselineManifestV1: geometry root + economy baseline root | `APEX-T6.2` | `DET-ESIM-007` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 47 | `APEX-T4.6` | SaveUniverseManifestV1 staged epoch commit | `APEX-T4.3b`, `APEX-T4.5` | `DET-SVC-021` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
...
| `DET-PRD-008` | PARTIAL | AllOf(`APEX-T5.1`, `APEX-T5.2`, `APEX-T7.1`) | `d1b8948369e0` |
| `DET-PRD-011` | PARTIAL | AllOf(`APEX-T6.6`, `APEX-T7.1`) | `d1b8948369e0` |
...
| `DET-WTH-010` | OPEN | AllOf(`APEX-T5.1`, `APEX-T5.4`) | `d1b8948369e0` |
