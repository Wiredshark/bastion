...
**Rows:** 53  **Findings:** 24  **Unresolved row references:** 1  
...
## Known open issues (validator-reported, not implementation bugs)

1. **`ORDER_VIOLATION`: `APEX-T4.3` depends on `APEX-T6.2`, which comes later in the canonical guide.** The master build order's Tier 4 (`WorldBaselineManifestV1`) is stated as `PREREQUISITE-MISSING: T0.5, T6 evidence probes` — but Tier 6 (numeric evidence probes) is documented *after* Tier 4 in the guide's top-to-bottom sequence. The guide's own execution rule ("clear strictly top-to-bottom") is inconsistent with this row's own stated prerequisite. This is a genuine cross-tier sequencing defect in the canonical guide, not a registry bug — flagged for the architect, not silently resolved here.
2. **`UNRESOLVED_ROW_REFERENCE`: `APEX-T5.5` is cited by three findings (`DET-WTH-010`, `DET-PRD-008`, `DET-PRD-011`) but does not exist anywhere in the canonical guide** (Tier 5 only defines `T5.1`–`T5.4`). Recorded verbatim rather than dropped or fabricated.
...
| 27 | `APEX-T4.3` | WorldBaselineManifestV1 | `APEX-T0.5`, `APEX-T6.2` | `DET-ESIM-007`, `DET-SVC-021` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
...
| 29 | `APEX-T4.5` | Historical save corpus + migration policy | `APEX-T4.3`, `APEX-T4.4` | `DET-SVC-021` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
...
| 46 | `APEX-T8.1` | Per-site/per-phase economy state-digest instrumentation | `APEX-T0.2`, `APEX-T0.3` | `DET-ESIM-007`, `DET-ESIM-008` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 47 | `APEX-T8.2` | Lane A: numeric-portability isolation | `APEX-T8.1` | `DET-ESIM-007` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/NOT_STARTED/NOT_STARTED/NOT_DEPLOYED |
| 48 | `APEX-T8.3` | Lane B: order-sensitivity isolation | `APEX-T8.1` | `DET-ESIM-007`, `DET-ESIM-008` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/NOT_STARTED/NOT_STARTED/NOT_DEPLOYED |
| 49 | `APEX-T8.4` | Lane C: quantization/ULP model-sensitivity isolation | `APEX-T8.1` | `DET-ESIM-007`, `DET-ESIM-008` | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/NOT_STARTED/NOT_STARTED/NOT_DEPLOYED |
| 50 | `APEX-T8.5` | Select smallest justified economy numeric remedy | `APEX-T8.2`, `APEX-T8.3`, `APEX-T8.4` | — | NEEDS_DESIGN/NOT_APPLICABLE/BLOCKED_ON_DESIGN/NOT_STARTED/NOT_DEPLOYED |
| 51 | `APEX-T9.1` | Full-bootstrap reconnect under new connection epoch | `APEX-T3.1`, `APEX-T3.2`, `APEX-T3.3`, `APEX-T3.4`, `APEX-T4.1`, `APEX-T4.2` | — | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 52 | `APEX-T9.2` | Explicit save rollback / UniverseBranchId authorization | `APEX-T4.6` | — | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/BLOCKED_ON_PREREQUISITE/NOT_STARTED/NOT_DEPLOYED |
| 53 | `APEX-T9.3` | Complete apex campaign certification | — | — | SPECIFICATION_COMPLETE/MICROSTEP_RESEARCH_COMPLETE/DEFERRED/NOT_STARTED/NOT_DEPLOYED |
...
| `DET-ESIM-007` | OPEN | AllOf(`APEX-T4.3`, `APEX-T8.1`, `APEX-T8.2`, `APEX-T8.3`, `APEX-T8.4`) | `d1b8948369e0` |
...
| `DET-SVC-021` | OPEN | AllOf(`APEX-T4.3`, `APEX-T4.4`, `APEX-T4.5`, `APEX-T4.6`) | `d1b8948369e0` |
