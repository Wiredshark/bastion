...
boot)
  ...
  case "$ARM" in
    ...
    mega)
      ...
      ENVV="BASTION_FLAT_WORLD=1 BASTION_TOWN_SIZE=1.0 BASTION_ADOPT_TOWN=1 BASTION_AUTOFOUND_REAL_TERRAIN=1 BASTION_COLONY_PRESENCE_VD=7 BASTION_AUTOFOUND_COLONY=48 BASTION_SEED_FOOD=256 BASTION_SEED_MATERIALS=256" ;;
