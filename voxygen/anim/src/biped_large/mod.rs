    ...
    fn from(body: &'a Body) -> Self {
        ...
        Self {
            head: match (body.species, body.body_type) {
                ...
                (Cyclops, _) => (9.5, 7.5),
                (Wendigo, _) => (3.0, 7.5),
                // bastion (NIGHT_HORROR): native wendigo frame — offsets verbatim.
                (NightHorror, _) => (3.0, 7.5),
                (Cavetroll, _) => (9.0, 7.0),
