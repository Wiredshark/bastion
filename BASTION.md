...
| Run overseer (B1/B1.5) | `target\debug\veloren-voxygen.exe --bastion-overseer` — B&W2 grab-drag/orbit/zoom + input contexts; see `docs/BASTION_CAMERA.md` |
