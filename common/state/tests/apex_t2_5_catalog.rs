...
const CLAIMED: &[(&str, &str)] = &[
    ...
    ("CONTENT-ALREADY-INSTALLED", ".12 one-time content generation installation"),
    ("CONTENT-GENERATION-INCOMPLETE", ".12"),
    ("CONTENT-NOT-INSTALLED", ".12"),
    ("CONTENT-PUBLICATION-ABORTED", ".12"),
    ("CONTENT-PUBLICATION-PASS", ".12"),
    ("CONTENT-ROOT-MISMATCH", ".12"),
    ("EARLY-ASSET-ACCESS", ".12: access-before-installation becomes a typed failure"),
    ("HOT-RELOAD-FORBIDDEN", ".12: assets_manager hot reload is not atomic publication; V1 forbids it by construction"),
    ("INCREMENTAL-PUBLICATION-FORBIDDEN", ".12 replaces incremental register_tar with one batch generation"),
