...
const INSTANT_SYSTEMTIME_BASELINE: [(&str, &str, u32); 160] = instant_systemtime_baseline();
...
/// reviewed.
const READ_DIR_BASELINE: [(&str, &str, u32); 21] = read_dir_baseline();
...
const fn instant_systemtime_baseline() -> [(&'static str, &'static str, u32); 160] {
...
const fn read_dir_baseline() -> [(&'static str, &'static str, u32); 21] {
