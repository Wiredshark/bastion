...
impl CaptureFormat {
    ...
    pub fn bytes_per_pixel(self) -> usize {
        match self {
            CaptureFormat::Rgba8UnormSrgb
            | CaptureFormat::R32Uint
            | CaptureFormat::Depth32Float => 4,
...
mod tests {
    ...
    fn padding_bytes_cannot_enter_the_digest() {
        ...
        assert_eq!(
            capture_bytes_digest(&id, &ta),
            capture_bytes_digest(&id, &tb)
        );
    }
    ...
    fn wrong_length_is_typed_failure() {
        ...
        assert_eq!(
            ...
            ExtractError::LengthMismatch {
                expected: d.padded_bytes_per_row() * 2,
                got: d.padded_bytes_per_row() * 2 - 1
            }
        );
    }
    ...
    fn capture_identity_binds_token_and_descriptor() {
        ...
        assert_ne!(
            d.capture_identity(1),
            d2.capture_identity(1),
            "descriptor field"
        );
    }
}
