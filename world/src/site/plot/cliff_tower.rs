...
use crate::{
    Land,
    site::util::{gradient::WrapMode, sprites::PainterSpriteExt},
...
impl Structure for CliffTower {
    #[cfg(feature = "dyn-lib")]
    #[unsafe(export_name = "as_dyn_structure_clifftower")]
    fn as_dyn_outer(&self) -> Option<(&dyn Structure, &'static str)> {
        Some((Self::as_dyn_impl(self), "as_dyn_structure_clifftower"))
    }
