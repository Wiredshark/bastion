...
impl Structure for SeaChapel {
    #[cfg(feature = "dyn-lib")]
    #[unsafe(export_name = "as_dyn_structure_seachapel")]
    fn as_dyn_outer(&self) -> Option<(&dyn Structure, &'static str)> {
        Some((Self::as_dyn_impl(self), "as_dyn_structure_seachapel"))
    }
    ...
    fn spawn_rules_inner(
        ...
        spawn_rules.trees &= !within_distance(wpos, self.center, 100);
    ...
    fn render_inner(&self, _site: &Site, _land: &Land, painter: &Painter) {
        ...
        let mut rng = super::plot_render_rng(self.center, 0x5EAC_0009);
        // Fills
