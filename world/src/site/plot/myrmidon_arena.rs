...
impl Structure for MyrmidonArena {
    #[cfg(feature = "dyn-lib")]
    #[unsafe(export_name = "as_dyn_structure_myrmidonarena")]
    fn as_dyn_outer(&self) -> Option<(&dyn Structure, &'static str)> {
        Some((Self::as_dyn_impl(self), "as_dyn_structure_myrmidonarena"))
    }
    ...
    fn render_inner(&self, _site: &Site, _land: &Land, painter: &Painter) {
        ...
        let mut rng = super::plot_render_rng(self.bounds.center(), 0x11A2_000A);
